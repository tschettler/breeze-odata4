import { AutoGeneratedKeyType, DataProperty, DataType, Entity, EntityAspect, KeyMapping, SaveResult } from 'breeze-client';
import { EntityErrorFromServer } from 'breeze-client/src/entity-manager';
import { AjaxAdapter, AjaxConfig, AjaxRequest } from 'breeze-client/src/interface-registry';
    ...
    const result = failedResponses
      .map(failedResponse => {
        ...
        const entityError = {
          ...
          errorMessage: failedResponse.response.body ?? failedResponse.message,
          errorName: null,
