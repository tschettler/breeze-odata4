import { AutoGeneratedKeyType, config, core, DataProperty, DataService, DataServiceAdapter, DataType, JsonResultsAdapter, EntityQuery, SaveResult, MetadataStore, EntityAspect, Entity } from 'breeze-client';
...
export class OData4ServiceAdapter implements ODataServiceAdapter {
    ...
    fetchMetadata(metadataStore: MetadataStore, dataService: DataService): Promise<any> {
        ...
        oData.read({
            ...
            /*oData.metadataHandler*/ oData.metadata.metadataHandler,
            null, null
        );
    ...
    executeQuery(mappingContext: { getUrl: () => string; query: EntityQuery; dataService: DataService; }): Promise<any> {
        ...
        oData.read(
            ...
            (data: any/*, response:any*/) => {
                ...
                deferred.resolve({ results: data.value, inlineCount: inlineCount, httpResponse: null /*response*/ });
            },
            (error: Object) => {
    ...
    private createChangeRequests(saveContext, saveBundle) {
        ...
        saveBundle.entities.forEach(function (entity: Entity, index) {
